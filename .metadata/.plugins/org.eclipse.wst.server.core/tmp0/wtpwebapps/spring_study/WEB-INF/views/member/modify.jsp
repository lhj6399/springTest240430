...
<h1>Member Modify Page</h1>
	...
	<div class="mb-3">
		...
		<div class="mb-3">
		  ...
		  <input type="text" class="form-control" name="reg_date" id="r" value="${ses.reg_date }" readonly="readonly" placeholder="reg_date...">
		</div>
		<div class="mb-3">
		  <label for="i" class="form-label">Last_Login</label>
		  <input type="text" class="form-control" name="last_login" id="l" value="${ses.last_login }" readonly="readonly" placeholder="last_login...">
		</div>
		<div class="mb-3">
		...
		<a href="/member/remove"><button type="button" class="btn btn-primary">delete</button></a>
	</form>
